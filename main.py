...
class Perceptron:
	...
	def __init__(self, epocas, taxa_aprendizagem):
		...
		self.total_variaveis_entrada = 4900     # são 80 vetores com 80 dados em cada um, no caso, 80 * 80 = 4900
		self.arquivo = ""

	def preencher_vetor(self):
		# onde cada posição armazena um vetor com os pesos iniciais
		for i in range(4900):           # serão 4900 dados dentro de cada vetor
...
for i in range(5):
	...
	for n in range(5):
		...
		if not n == i:
			...
			print 'pesos... '
			print perceptronControlador.pesos
